...
public abstract class XmlStringBuilder {
  ...
  /**
   * As above but with namespace separate
   *
   * @param ns
   * @param tagName
   * @return this
   */
  public abstract XmlStringBuilder wrapWithNs(String ns, String tagName);
   ...
   * @return this
   */
  public abstract XmlStringBuilder wrapWithNs(String ns, String tagName, String... attribs);
