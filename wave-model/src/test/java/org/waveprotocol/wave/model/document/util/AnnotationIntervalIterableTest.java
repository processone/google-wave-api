 ...
 */
public abstract class AnnotationIntervalIterableTest<S extends RawAnnotationSet<Object>>
    extends TestCase {

  protected abstract S getNewSet();
  protected abstract Iterable<AnnotationInterval<Object>> getIterable(S set, int start, int end,
